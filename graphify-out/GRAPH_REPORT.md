...
Cohesion: 0.5
Nodes (8): clean_md_title(), parse_menu_md(), pick_icon(), pick_item_icon(), render_cards(), render_menu(), render_menu_from_labels(), strip_leading_number()

### Community 1 - "Community 1"
Cohesion: 0.32
Nodes (8): Aula 1: Engenharia de Prompt para Análises Investigativas, Aula 2: Advanced Prompt Engineering Techniques, Aula 2 Prática: Practical Exercises, Copy to Clipboard Function, Exemplo de Dados Tópico 1: Bank Fraud Investigation, Exemplo de Dados Tópico 2: Multi-person Fraud Network, Dark Mode Toggle Implementation, Prompt ID Naming Convention
...
Cohesion: 0.4
Nodes (5): assign_unique_icons(), main(), parse_args(), render_topics_menu(), replace_between()
...
- **Why does `aulas-engenharia-prompt Project` connect `Community 6` to `Community 1`, `Community 7`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Pedagogical Lesson Structure Pattern` connect `Community 8` to `Community 1`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Aula 2: Advanced Prompt Engineering Techniques` connect `Community 1` to `Community 8`, `Community 6`, `Community 7`?**
